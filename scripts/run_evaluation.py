...
def main():
    ...
    cmd = "python allennlp_overrides/commands/evaluate.py {} {} ".format(serialization_dir, args.dev_file) + \
        ...
        " -o "+'"{'+" iterator: "+'{'+"batch_size: 1"+'}'+", model: "+'{'+\
            "temperature_threshold: {}, scaling_temperature: '{}', gold_exit_during_test: {}, earliest_exit_during_test: {}".format(args.confidence_threshold, args.temperatures, args.gold_exit_during_test, args.earliest_exit_during_test)+\
...
def arg_parser():
    ...
    p.add_argument('--earliest_exit_during_test', help="Exit when max label == gold label at test time", type=str, default="false")
